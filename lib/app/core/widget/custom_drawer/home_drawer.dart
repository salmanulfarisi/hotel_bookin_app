...
//   const HomeDrawer({Key? key, DrawerIndex? screenIndex, required Null Function(DrawerIndex indexType) callBackIndex, AnimationController? iconAnimationController}) : super(key: key);
...
//                               color: controller.drawerIndex == listData.index
//                                   ? Colors.blue
...
//               ),
//             ),
//             controller.drawerIndex == listData.index
//                 ? AnimatedBuilder(
//                     animation: controller.animationController!,
//                     builder: (BuildContext context, Widget? child) {
//                       return Transform(
...
//     controller.callbackIndex!(indexScreen);
//   }
// }
